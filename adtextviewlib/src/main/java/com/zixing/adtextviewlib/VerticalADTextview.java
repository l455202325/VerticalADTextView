package com.zixing.adtextviewlib;
...
/**
 * 类作用：
 * Created by zixing on 16/10/18.
 */
public class VerticalADTextview extends TextSwitcher implements  ViewSwitcher.ViewFactory {
    ...
    public VerticalADTextview(Context context) {
        this(context, null);
        mContext = context;
    }

    public VerticalADTextview(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
